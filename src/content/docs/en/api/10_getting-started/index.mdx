...
<Callout type="note">
AppLovin is not a a part of the Families Self Certified Ads <Abbr>SDK</Abbr> Program.
According to Google if your app is designed for children or includes children you must adhere to [Google Play’s Families Policy Requirements](https://support.google.com/googleplay/android-developer/topic/9877766#!?zippy_activeEl=families-policy#families-policy) and use only [Families Self-Certified Ads <Abbr>SDK</Abbr>s](https://support.google.com/googleplay/android-developer/answer/9900633/?sjid=4660822843944323705-NC).
For more information, see the Privacy documentation page for your platform.
</Callout>
