        ...
        implements MaxAdViewAdListener
{
  ...
  void createBannerAd()
  {
    adView = new MaxAdView( "<var>ad_unit_ID</var>", this );
...
class ExampleActivity : Activity(), MaxAdViewAdListener
{
  ...
  fun createBannerAd()
  {
    adView = MaxAdView("<var>ad_unit_ID</var>", this)
    adView?.setListener(this)
        ...
        implements MaxAdViewAdListener
{
  ...
  void createMrecAd
  {
    adView = new MaxAdView( "<var>ad_unit_ID</var>", MaxAdFormat.MREC, this );
    adView.setListener( this );
...
class ExampleActivity : Activity(), MaxAdViewAdListener
{
  ...
  fun createMrecAd()
  {
    adView = MaxAdView("<var>ad_unit_ID</var>", MaxAdFormat.MREC, this)
    adView?.setListener(this)
...
<com.applovin.mediation.ads.MaxAdView
  ...
  maxads:adUnitId="<var>ad_unit_ID</var>"
